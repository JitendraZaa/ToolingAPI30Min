...
client.ajax('/'+client.apiVersion+'/tooling/sobjects/'+curSelRes.resType+'/'+curSelRes.Id,
                    function(data){ 
						if(data.Body)
							$("#codeBody").text(data.Body);  
						else
							$("#codeBody").text(data.Markup); 
...
function createMetadataContainer(resId)
{
    ...
    client.ajax('/'+client.apiVersion+'/tooling/sobjects/MetadataContainer',
                    function(data){ 
                        ...
                        createResourceMember(metadataInfo, resId,$("#codeBody").text());
                    },
                    function (error) { 
...
{ 
	...
	client.ajax('/'+client.apiVersion+'/tooling/executeAnonymous/?anonymousBody='+encodeURIComponent($("#codeBody").text()) ,
                    function(data){
						if(data.compiled)
						{
